 ...
 * @param {'pitches'|'statuses'|'avatars'|'cmms-reports'|'cmms-announcements'|'voice-notes'|'portfolio-chat'|'cmms-employment-documents'|'cmms-opportunities'|'portfolio-certificates'} params.folder
