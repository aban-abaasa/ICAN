        ...
        {!advice.shouldProceed && advice.wealthImpact && (
          <div className="mb-4 p-4 bg-gradient-to-r from-green-500 to-blue-500 bg-opacity-20 rounded-lg border border-green-400 border-opacity-30">
            ...
            <div className="text-xs text-gray-300 text-center mt-1">
              That's enough to move up in your IcanEra journey stages!
            </div>
          </div>
        )}
      ...
      <div className="glass-card p-0 max-w-2xl w-full h-[80vh] flex flex-col">
        ...
        <div className="p-4 border-b border-white border-opacity-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-white font-medium">IcanEra AI Assistant</h3>
    ...
    <div className="glass-card p-4">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <span className="text-white font-medium">IcanEra Journey Progress</span>
        </div>
...
const ICANCapitalEngine = () => {
  ...
  const journeyStages = {
    ...
    4: {
      ...
      solution: "Global Navigator and IcanEra Profile Analyzer for Gap Analysis.",
    ...
    switch(stage) {
      ...
      case 4: // Readiness
        actions.push(
          ...
          'Achieve 95%+ IcanEra Opportunity Rating',
  ...
  const AdvancedReportingSystem = ({ transactions, isOpen, onClose, netWorth }) => {
    ...
    const [emailSettings, setEmailSettings] = useState({
      recipient: '',
      subject: 'IcanEra Financial Report',
      message: 'Please find attached your comprehensive financial report generated by IcanEra Capital Engine.',
    ...
    const reportTypes = {
      ...
      'wealth-journey': {
        name: '🚀 IcanEra Wealth Journey Analytics',
      ...
      try {
        ...
        switch (format) {
          case 'pdf':
            ...
            attachmentName = `IcanEra_Financial_Report_${new Date().toISOString().slice(0, 10)}.pdf`;
            mimeType = 'application/pdf';
            break;
          case 'excel':
            reportContent = generateExcelData(reportData);
            attachmentName = `IcanEra_Financial_Data_${new Date().toISOString().slice(0, 10)}.xlsx`;
            mimeType = 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet';
            break;
          case 'html':
            reportContent = await generatePDFReport(reportData); // Use HTML version
            attachmentName = `IcanEra_Financial_Report_${new Date().toISOString().slice(0, 10)}.html`;
            mimeType = 'text/html';
            break;
          default:
    ...
    const generateEmailBody = (reportData) => {
      ...
      return `
Dear IcanEra Capital Engine User,
...
Best regards,
IcanEra Capital Engine - Your AI Financial Intelligence System
...
Data Freshness: ${reportData.metadata.dataFreshness}
  ...
  const getStageSpecificGuidance = (transaction, stage) => {
    ...
    switch(stage) {
      ...
      default:
        return `🎯 IcanEra JOURNEY: Your spending decisions impact your progression through the four-stage journey to global capital readiness.`;
    }
  };
