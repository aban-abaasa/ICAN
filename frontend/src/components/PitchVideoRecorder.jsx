...
const PitchVideoRecorder = ({ onPitchCreated, onClose }) => {
  ...
  return (
    <div className="w-full h-screen md:h-auto md:max-w-4xl md:mx-auto px-0 relative flex flex-col md:flex-col">
      {/* Transparent Close Icon */}
      {onClose && (
        <button
          onClick={onClose}
          className="absolute top-2 right-3 md:top-4 md:right-4 w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/10 hover:bg-white/20 text-white/60 hover:text-white flex items-center justify-center transition z-50 focus:outline-none focus:ring-2 focus:ring-white/30"
          aria-label="Close"
        >
          <X className="w-5 h-5 md:w-6 md:h-6" />
        </button>
      )}
      <div className="bg-slate-800 rounded-none md:rounded-2xl p-0 md:p-8 border-0 md:border border-slate-700 h-full md:h-auto flex flex-col md:flex-col overflow-hidden md:overflow-visible flex-1 md:flex-none md:space-y-6">
        {/* Collapsed Header - Desktop only */}
        <div className="hidden md:block mb-3 md:mb-6 px-3 md:px-0">
        ...
        {/* Video Preview/Recording - Full screen on mobile */}
        <div className="flex-1 md:flex-shrink-0 md:mb-8 px-0 md:px-0 relative w-full h-full md:h-auto">
          <div style={{
            backgroundColor: '#000',
            borderRadius: '0rem',
            overflow: 'hidden',
            ...
            <div className="absolute bottom-3 md:bottom-4 left-3 md:left-4 flex gap-2 z-40">
              {!previewUrl ? (
                <>
                  ...
                  <div className="relative group">
                    <button
                      ...
                      className="relative w-10 h-10 md:w-12 md:h-12 rounded-full bg-red-600 hover:bg-red-700 disabled:bg-slate-600 text-white flex items-center justify-center transition group focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-slate-900"
                    >
                  ...
                  {isRecording && (
                    <div className="relative group">
                      <button
                        ...
                        className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-slate-700 hover:bg-slate-600 text-white flex items-center justify-center transition focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 focus:ring-offset-slate-900"
                      >
                  ...
                  {/* Upload Video Button */}
                  <div className="relative group">
                    <label className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center transition cursor-pointer focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2 focus-within:ring-offset-slate-900">
            ...
            {/* Overlay - Form Toggle Pin Icon at top-right */}
            <div className="absolute top-3 md:top-4 right-3 md:right-4 z-40">
              <button
                onClick={() => setIsFormExpanded(!isFormExpanded)}
                className="relative group w-10 h-10 md:w-12 md:h-12 rounded-full bg-slate-700/80 hover:bg-slate-600 text-purple-400 hover:text-purple-300 flex items-center justify-center transition focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-slate-900"
              >
