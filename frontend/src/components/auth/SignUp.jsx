  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8" style={{ backgroundImage: palette.pageBg }}>
      <div className="max-w-md w-full backdrop-blur-xl rounded-[30px] shadow-2xl p-8 border" style={{ backgroundColor: palette.cardBg, borderColor: palette.cardBorder, boxShadow: palette.cardShadow }}>
        ...
        {/* Google Sign Up Button -- the quickest path, especially for a
            candidate creating an account just to keep track of a job
            application/interview: no password to invent, no email to
            confirm before they can use it. */}
        <button
          type="button"
          ...
          style={{ backgroundColor: palette.inputBg, color: palette.text, border: `1px solid ${palette.inputBorder}` }}
          onClick={async () => {
