...
import { CheckCircle, AlertCircle, Loader2, ArrowLeft, Lock, Eye, EyeOff } from 'lucide-react';
...
const ResetPassword = ({ onBackToSignIn }) => {
  ...
  const handleBackToSignIn = async () => {
    try {
      ...
      // Ignore sign-out errors and still route user back.
    }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4">
        <div className="glass-card p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-400 mb-6">Your password has been reset successfully. Please sign in with your new password.</p>
          <button
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-11 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all"
