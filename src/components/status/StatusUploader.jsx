        ...
        <div className="p-6 space-y-4 overflow-y-auto flex-1 pr-8">
          ...
          {showCamera && isCameraReady ? (
            <div className="relative rounded-xl overflow-hidden bg-black aspect-video">
              ...
              {/* Camera Controls */}
              <div className="absolute inset-0 flex items-end justify-center gap-4 p-4 bg-gradient-to-t from-black/60 to-transparent">
                <button
                  onClick={captureImage}
                  className="w-14 h-14 rounded-full bg-white hover:bg-gray-100 text-black flex items-center justify-center transition-all transform hover:scale-110 shadow-lg"
                  title="Capture"
                >
                ...
                <button
                  onClick={stopCamera}
                  className="w-14 h-14 rounded-full bg-red-500 hover:bg-red-600 text-white flex items-center justify-center transition-all transform hover:scale-110 shadow-lg"
                  title="Cancel"
                >
                  <X className="w-6 h-6" />
                </button>
            ...
            <div className="space-y-3">
              ...
              <button
                onClick={startCamera}
                className="w-full border-2 border-purple-500 rounded-xl p-6 text-center hover:bg-purple-500/10 transition-all group"
              >
                <Camera className="w-8 h-8 text-purple-400 mx-auto mb-2 group-hover:scale-110 transition-transform" />
                <p className="text-sm font-medium text-purple-300">Take Photo</p>
                <p className="text-xs text-purple-400 mt-1">Capture from camera</p>
              </button>

              {/* File Upload Option */}
              <button
                onClick={() => fileInputRef.current?.click()}
                className="w-full border-2 border-dashed border-slate-600 rounded-xl p-6 text-center cursor-pointer hover:border-blue-500 hover:bg-blue-500/5 transition-all group"
              >
                <Upload className="w-8 h-8 text-slate-400 mx-auto mb-2 group-hover:text-blue-400 group-hover:scale-110 transition-all" />
                <p className="text-sm font-medium text-gray-400 group-hover:text-blue-300">Upload Media</p>
